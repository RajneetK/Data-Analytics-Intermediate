...
The objective is to minimize “Net Credit Loss” and Scorecard is used for determining desired trade-off between risk level and approval rate.



#Conclusion

Final analysis is as below –
•	With suggested optimal cut off score of 395, avg. 71% of applicants would be approved.   Hence 29% applicants would be rejected.
•	Assumption regarding credit loss- Outstanding balance of a defaulter is considered as credit loss for the specific user.
•	Credit loss avoided by applying the model/scorecard implementation.
